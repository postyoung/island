        ...
        <div class="container" style="width: 1320px;">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" id="header-menu">
            <a href="${root}/main" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              <img src="${root}/resources/img/common-logo/main-logo.png" alt="로고" width="200px" height="100px" id="logo-photo">
            </a>
  			
  			<div id="list-box">
	            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
	              <li>
	                <a href="${root}/group/list" class="nav-link text-black box-a">
	                  <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#speedometer2"/></svg>
	                  모임
	                </a>
	              </li>
	              <li>
	                <a href="${root}/seminar/list" class="nav-link text-black box-a">
	                  <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#table"/></svg>
	                  세미나
	                </a>
	              </li>
	              <li>
	                <a href="${root}/community/notice/list" class="nav-link text-black box-a">
	                  <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#table"/></svg>
	                  커뮤니티
	                </a>
	              </li>
	              ...
	              <li class="nav-item dropdown">
	                <a class="nav-link dropdown-toggle box-a" id="mypage" href="${root}/mypage/home" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="padding-top: 33px;">
	                  마이페이지
	                </a>
	              ...
	              <li>
	                <a href="#" class="nav-link text-black box-a" id="bel">
