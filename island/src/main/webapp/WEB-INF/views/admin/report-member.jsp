			...
			<div id="wrap">
				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4 mt-4">
						<div class="card-body">
							<form action="${root}/admin/report/member" method="get">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									<c:forEach items="${MemberReportList}" var="mrl">
										<tr class="align-middle"
											onclick="location.href='${root}/admin/report/member/detail?no=${mrl.memberReportNo}'">
											<td>${mrl.memberReportNo}</td>
											<td>${mrl.id}</td>
											<td>${mrl.category}</td>
											<td>${mrl.reportYn}</td>
										</tr>
							...
							<div class="d-flex justify-content-center">
								<%@include
									file="/WEB-INF/views/common/admin-report-member-paging.jsp"%>
							</div>
						</div>
					</div>
				</div>
