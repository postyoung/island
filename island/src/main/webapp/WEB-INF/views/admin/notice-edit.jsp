				...
				<h2>공지사항 수정/삭제</h2>
						<form action="" method="post">
							...
							<table id="tableTitle" class="table table-bordered table-hover">
								<tr>
									<td>제목</td>
									<td><input name="title" type="text" style="font-size: 20px;" value="${vo.title}"	class="form-control"></td>
								</tr>
								<tr>
									<td>작성자</td>
									<td><input name="writer" type="text" style="font-size: 20px;" value="${vo.writer}" class="form-control"></td>
								</tr>
								<tr>
									<td>내용</td>
							...
							<a href="notice-list"><button type="button" class="btn btn-lg btn-info">목록</button></a>
