			...
			<div id="wrap">
				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4 mt-4">
						<div class="card-body">
							<form action="${root}/admin/report/review" method="get">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									<c:forEach items="${ReviewReportList}" var="rrl">
										<tr class="align-middle"
											onclick="location.href='${root}/admin/report/review/detail?no=${rrl.reportNo}'">
											<td>${rrl.reportNo}</td>
											<td>${rrl.title}</td>
											<td>${rrl.category}</td>
											<td>${rrl.reportYn}</td>
							...
							<div class="d-flex justify-content-center">
								<%@include
									file="/WEB-INF/views/common/admin-report-review-paging.jsp"%>
							</div>
						</div>
					</div>
				</div>
